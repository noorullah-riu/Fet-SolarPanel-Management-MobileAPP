...
export const UpdateEmail = props => {
  ...
  const updateEmailAccount = async () => {
    ...
    try {
      dispatch(Services.update_profileE(obj)).then(data => {
        if (data.payload) {
    ...
    <>
      ...
      <View style={styles.divP}>
        <View style={styles.h70}>
          <Text style={styles.usernameText}>Enter Old Email</Text>
        </View>
        ...
        <View style={styles.h70}>
          <Text style={styles.usernameText}>Enter New Email</Text>
        </View>
        <View style={styles.inputEmail}>
          <TextInput
