...
import BarChart4Devices from '../Components/BarChart4Devices';
...
export const DeviceDetailGrid = ({navigation, route}: any) => {
  ...
  const getLIneChartDataTop = async date => {
    ...
    try {
      dispatch(Services.getChartInverter1(obj)).then(data => {
        console.log(
          JSON.stringify(data.payload?.KW?.kw?.length),
          'fgetChartGrid',
        );
    ...
    <View style={style.f1}>
      ...
      <ScrollView>
        ...
        <View style={style.pDiv}>
          ...
          <View style={style.rowStart}>
            <View style={style.f1}>
              <Text style={style.leftTxt}>Total Import Energy</Text>
            </View>
            <View style={style.f1}>
              <Text style={style.rightTxt}>
                {twoDecimal(deviceData?.Total_Import_Energy) || 0} KWH
              </Text>
            </View>
          </View>
          ...
          <View style={style.rowStart}>
            ...
            <View style={style.f1}>
              <Text style={style.rightTxt}>
                {twoDecimal(deviceData?.Total_Export_Energy) || 0} KWH
              </Text>
            </View>
          </View>
        </View>
